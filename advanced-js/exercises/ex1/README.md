...
1. In this exercise, you will modify the existing code for a "note taking app".

2. Using what you learned about closure and the module pattern, modify the code to wrap all the functionality up into a simple object (call it "NotesManager" or something appropriate), with a simple API, consisting of:
